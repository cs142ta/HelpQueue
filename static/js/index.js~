...
//------------------------ Edit Raw data stuff -----------------------------------------
	...
	$("#easterEggTrigger").on("click", function()
	{
		var output = '<div><center>' + 
			...
			' <br/>This help queue was designed and built by Blaine McGary during the Winter Semester 2016. It was ' +
			' first used during the Winter 2016 semester in the class CS 240.' + '<br/>This CS 142 version is currently maintained by Gandalf the Grey.' +
			'</center></div>';
